...
// --- DATA SOURCE ---
const SUB_CHANNELS = [
  { id: "flickreels", name: "FlickReels", desc: "Short cinematic universe.", status: "ACTIVE", code: "F-01" },
  { id: "netshort", name: "NetShort", desc: "Vertical series HD.", status: "ACTIVE", code: "N-01" },
  { id: "dramabox", name: "DramaBox", desc: "Daily curated picks.", status: "LOCKED", code: "D-01" },
  { id: "reelshort", name: "ReelShort", desc: "Snack-sized drama.", status: "LOCKED", code: "R-01" },
  { id: "melolo", name: "Melolo", desc: "Asian variety shows.", status: "SOON", code: "M-01" },
];
...
export default function LandingPage() {
  return (
    <main className="min-h-dvh flex flex-col relative overflow-x-hidden font-sans pb-24">
      ...
      {/* ... (Hero Section dan lainnya biarkan seperti sebelumnya) ... */}

      {/* =========================================
          SECTION: KOLEKSI ARSIP (RE-DESIGNED)
         ========================================= */}
                ...
                {SUB_CHANNELS.map((ch) => (
                    <div key={ch.id} className="group archive-card p-5 bg-white hover:bg-[#FDFFB6]/20 transition-colors">
                        ...
                        <div className="flex items-center justify-between pt-3 border-t-2 border-dashed border-[#121212]/10">
                            ...
                            {/* Link/Button (Disabled look if locked/soon, but structure preserved) */}
                            {ch.status === 'ACTIVE' ? (
