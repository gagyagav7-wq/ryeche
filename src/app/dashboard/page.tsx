...
// NEW: Icon for Movie Hub
const IconFilm = () => <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" className="w-8 h-8"><rect x="2" y="2" width="20" height="20" rx="2.18" ry="2.18"/><line x1="7" y1="2" x2="7" y2="22"/><line x1="17" y1="2" x2="17" y2="22"/><line x1="2" y1="12" x2="22" y2="12"/><line x1="2" y1="7" x2="7" y2="7"/><line x1="2" y1="17" x2="7" y2="17"/><line x1="17" y1="17" x2="22" y2="17"/><line x1="17" y1="7" x2="22" y2="7"/></svg>;
...
         {/* --- MODULES GRID (Updated to 3 columns on large screens) --- */}
...
            {/* 2. MOVIE HUB (Rebahin Style) */}
            <Link href="/movies" className="group relative bg-[#FF99C8] border-[3px] border-[#0F172A] rounded-[20px] p-8 md:p-10 shadow-[6px_6px_0px_#0F172A] hover:-translate-y-[2px] hover:shadow-[8px_8px_0px_#0F172A] transition-all duration-300 overflow-hidden text-[#0F172A]">
...
                   <div className="w-16 h-16 bg-white border-[3px] border-[#0F172A] rounded-2xl flex items-center justify-center shadow-[4px_4px_0px_#0F172A] group-hover:scale-110 transition-transform">
                      <IconFilm />
                   </div>
                   <span className="bg-white text-[#0F172A] border-[2px] border-[#0F172A] px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest shadow-[2px_2px_0px_#0F172A]">Main App</span>
                </div>
                <h3 className="relative z-10 text-3xl font-black uppercase mb-3 leading-tight">Movie Hub</h3>
                <p className="relative z-10 font-black text-sm opacity-80 mb-8 leading-relaxed">Access a wide library of global cinema and international movies.</p>
                <div className="relative z-10 inline-flex items-center gap-2 font-black uppercase text-xs bg-white px-4 py-2.5 rounded-lg border-[3px] border-[#0F172A] shadow-[4px_4px_0px_#0F172A] group-hover:translate-x-1 transition-transform">Explore Cinema &rarr;</div>
            </Link>
...
                <div className="flex justify-between items-start mb-8 relative z-10">
                   <div className="w-16 h-16 bg-white border-[3px] border-[#0F172A] rounded-2xl flex items-center justify-center shadow-[4px_4px_0px_#0F172A] group-hover:-rotate-6 transition-transform text-[#0F172A]"><IconBolt /></div>
...
                <div className="relative z-10 inline-flex items-center gap-2 font-black uppercase text-xs bg-white text-[#0F172A] px-4 py-3 rounded-lg border-[3px] border-[#0F172A] shadow-[3px_3px_0px_#0F172A] group-hover:translate-x-1 transition-transform">Open Tool &rarr;</div>
            </Link>
...
                     <div className="flex items-center gap-3">{item.icon}<span className="font-bold text-xs uppercase">{item.label}</span></div>
...
        <p className="font-mono text-[10px] font-bold uppercase tracking-widest opacity-60">Session Secure • DawgHub OS v2.0</p>
      </footer>
